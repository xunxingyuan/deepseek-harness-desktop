...
**Current release: [DSH Desktop v0.1.12](https://github.com/xunxingyuan/deepseek-harness-desktop/releases/tag/v0.1.12)**

| Platform | Recommended download |
| --- | --- |
| Windows x64 | [EXE installer](https://github.com/xunxingyuan/deepseek-harness-desktop/releases/download/v0.1.12/DSH.Desktop_0.1.12_x64-setup.exe) |
| Windows x64 (managed deployment) | [MSI installer](https://github.com/xunxingyuan/deepseek-harness-desktop/releases/download/v0.1.12/DSH.Desktop_0.1.12_x64_zh-CN.msi) |
| Apple Silicon Mac | [DMG installer](https://github.com/xunxingyuan/deepseek-harness-desktop/releases/download/v0.1.12/DSH.Desktop_0.1.12_aarch64.dmg) |
| Intel Mac | [DMG installer](https://github.com/xunxingyuan/deepseek-harness-desktop/releases/download/v0.1.12/DSH.Desktop_0.1.12_x64.dmg) |

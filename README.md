...
| Windows x64 (managed deployment) | [MSI installer](https://github.com/xunxingyuan/deepseek-harness-desktop/releases/download/v0.1.8/DSH.Desktop_0.1.8_x64_zh-CN.msi) |
| Apple Silicon Mac | [DMG installer](https://github.com/xunxingyuan/deepseek-harness-desktop/releases/download/v0.1.8/DSH.Desktop_0.1.8_aarch64.dmg) |
| Intel Mac | [DMG installer](https://github.com/xunxingyuan/deepseek-harness-desktop/releases/download/v0.1.8/DSH.Desktop_0.1.8_x64.dmg) |

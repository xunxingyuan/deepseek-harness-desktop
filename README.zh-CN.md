...
**当前版本：[DSH Desktop v0.1.8](https://github.com/xunxingyuan/deepseek-harness-desktop/releases/tag/v0.1.8)**

| 平台 | 推荐下载 |
| --- | --- |
| Windows x64 | [EXE 安装包](https://github.com/xunxingyuan/deepseek-harness-desktop/releases/download/v0.1.8/DSH.Desktop_0.1.8_x64-setup.exe) |
| Windows x64（企业或集中部署） | [MSI 安装包](https://github.com/xunxingyuan/deepseek-harness-desktop/releases/download/v0.1.8/DSH.Desktop_0.1.8_x64_zh-CN.msi) |
| Apple 芯片 Mac | [DMG 安装包](https://github.com/xunxingyuan/deepseek-harness-desktop/releases/download/v0.1.8/DSH.Desktop_0.1.8_aarch64.dmg) |
| Intel 芯片 Mac | [DMG 安装包](https://github.com/xunxingyuan/deepseek-harness-desktop/releases/download/v0.1.8/DSH.Desktop_0.1.8_x64.dmg) |
...
桌面版使用启动时加载 profile，不开启开发态文件热重载监听，减少后台资源占用。
